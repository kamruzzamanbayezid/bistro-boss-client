                        ...
                        <div className='w-full lg:w-[45%]'>
                              ...
                              <form className='space-y-6' onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div className='space-y-4'>
                                          <label className='text-[#444] text-xl font-semibold' htmlFor="name">Name</label>
                                          <input
                                                type="text"
                                                name="name"
                                                id="name"
                                    ...
                                    {/* Image field */}
                                    <div className='space-y-4'>
                                          <label className='text-[#444] text-xl font-semibold' htmlFor="image">Upload Image</label>
                                          <input
                                                type="file"
                                                name="image"
                                                id="image"
                              ...
                              <div className='mt-7'>
                                    <p className='text-[#D1A054] text-xl text-center font-medium mb-6'>
                                          Already registered? <Link to='/login'><span className='font-bold hover:underline'>Go to log in</span></Link>
                                    </p>
